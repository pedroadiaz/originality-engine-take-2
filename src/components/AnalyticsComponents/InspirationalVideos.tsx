  ...
  return (
    <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
      <div className="flex overflow-hidden relative flex-col px-8 pt-9 pb-3.5 w-full rounded-2xl min-h-[445px] max-md:px-5 max-md:mt-5 max-md:max-w-full">
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/a18747dcde9d7b132c6e56fe15a0df79692b3a99224823ac6958d2cd5964649e?placeholderIfAbsent=true&apiKey=3502b91ecd184de6be2f646c5a302933"
          alt=""
        ...
        <div className="flex relative flex-wrap gap-5 justify-between items-start w-full max-md:mr-1.5 max-md:max-w-full">
          <div className="flex flex-col">
            ...
            <div className="self-start mt-1.5 text-sm font-medium leading-none text-slate-400">
              Example videos
            </div>
          </div>
        ...
        <div className="flex relative flex-wrap gap-4 mt-2.5">
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/1e9d2f527803219f479b18fa13a6558d2ee4d7d857e2795ceb63a44b40890ff9?placeholderIfAbsent=true&apiKey=3502b91ecd184de6be2f646c5a302933"
            alt=""
          ...
          <div className="flex overflow-hidden flex-wrap flex-auto gap-10 self-end px-6 py-3 mt-8 rounded-3xl bg-blue-950 bg-opacity-40 max-md:px-5 max-md:max-w-full">
            <div className="flex gap-5">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/09b68de75a836a63ba945a6118200f7bc6e3215cc252a8fe612b523600d8da0a?placeholderIfAbsent=true&apiKey=3502b91ecd184de6be2f646c5a302933"
                alt=""
